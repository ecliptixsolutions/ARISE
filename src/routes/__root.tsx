...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Arise Healthcare Solutions" },
      { name: "theme-color", content: "#0878CE" },
      { property: "og:site_name", content: "Arise Healthcare Solutions" },
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", href: "/arise-logo.png" },
      ...
      <head>
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=2627672500983550&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        {/* End Meta Pixel Code */}
